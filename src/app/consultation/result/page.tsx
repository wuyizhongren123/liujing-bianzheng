  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <div className="container mx-auto px-4 py-6 max-w-2xl">
        ...
        {/* 微信联系 */}
        <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-5 border-2 border-green-200 text-center">
          <p className="text-stone-700 mb-2">如需进一步指导请联系微信</p>
          <button
            onClick={() => {
              navigator.clipboard.writeText('ZRLSGZRLS');
              alert('微信号已复制：ZRLSGZRLS');
            }}
            className="inline-flex items-center gap-2 px-5 py-2 bg-green-600 text-white rounded-lg font-bold text-lg hover:bg-green-700 transition-colors"
          >
          ...
          <p className="text-stone-500 text-xs mt-2">点击复制微信号</p>
        </div>
      </div>
    </div>
  );
